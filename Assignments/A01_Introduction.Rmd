...
EnoDischargeViolin<-ggplot(EnoDischargeAssignment1Final, 
  ...
  geom_violin(draw_quantiles = c(0.5),aes(fill=factor(Year))) +
  labs(title="The Effect of Year on Eno River Discharge", y="Discharge (ft^3/s)")+ scale_y_continuous(breaks=c(0, 1000, 2000, 3000, 
